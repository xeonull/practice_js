...
Function.prototype.myBindViaCall = function (context, ...arg) {
  return (...rest) => {
    return this.call(context, ...arg, ...rest);
  };
};
...
Function.prototype.myBind = function (context, ...arg) {
  return (...rest) => {
    ...
    const res = context[uniqueField](...arg, ...rest);
...
printer.printName.myBind({name:'Alex'}, "mr").myBind(printer)("great", "super");
